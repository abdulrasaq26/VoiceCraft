...
class _StockCommon(BaseModel):
    ...
    concept: str = Field(
        description=(
            ...
            "IT MUST BE A SHOT ANYONE COULD FILM: the footage comes from "
            "public-domain and CC0 libraries, which contain the world but not "
            "named people, branded acts, films, characters, logos or "
            "trademarked events. Naming one describes footage that does not "
            "exist, and the search then returns anything at all - measured, a "
            "beat asking for a named stage act came back with cattle. When the "
            "narration names something unfilmable, shoot the closest honest "
            "thing and let the narration carry the name: for 'the Blue Man "
            "Group toured arenas', 'a darkened arena stage under coloured "
            "lights, drums and a crowd silhouetted in front of it', never 'the "
            "Blue Man Group performs on stage'. "
