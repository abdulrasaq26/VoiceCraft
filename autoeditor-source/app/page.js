            ...
            <p style={{ color: "#aaa", fontSize: 13, marginBottom: 16 }}>Paste the Motion JSON generated by the external AI to apply structured movement to your timeline clips.</p>
              ...
              <button 
                onClick={() => {
                  ...
                  const text = "TIMELINE CONTEXT (Use these exact clipIds in your JSON):\n" + JSON.stringify(validClips, null, 2);
                  navigator.clipboard.writeText(text);
                  alert("Copied! Paste this to your AI so it knows your exact clipIds.");
                }}
              ...
              >
                <span>📋 Copy Timeline Context for AI</span>
              </button>
